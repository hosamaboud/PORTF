...
//   const dev_1Ref = useRef(null);
//   const subtitle_1Ref = useRef(null);
//   const dev_2Ref = useRef(null);
//   const subtitle_2Ref = useRef(null);
//   const dev_3Ref = useRef(null);
//   const subtitle_3Ref = useRef(null);
//   const dev_4Ref = useRef(null);
//   const subtitle_4Ref = useRef(null);
//   const dev_5Ref = useRef(null);
//   const subtitle_5Ref = useRef(null);
//   const dev_6Ref = useRef(null);
//   const subtitle_6Ref = useRef(null);
...
//         });
//       const elements = [
//         [dev_1Ref, subtitle_1Ref],
//         [dev_2Ref, subtitle_2Ref],
//         [dev_3Ref, subtitle_3Ref],
//         [dev_4Ref, subtitle_4Ref],
//         [dev_5Ref, subtitle_5Ref],
//         [dev_6Ref, subtitle_6Ref],
//       ];

//       elements.forEach(([devRef, subtitleRef]) => {
//         const timeline = tl_dev(devRef);
//         timeline
//           .fromTo(
//             devRef.current,
//             { y: 50, opacity: 0 },
...
//           .to(
//             devRef.current,
//             { y: -50, opacity: 0, scale: 0.8,duration: 2, ease: 'power2.inOut' },
//             '+=1'
//           )
//           .to(
//             subtitleRef.current,
...
//       <div
//         ref={leftRef}
//         className=" z-20 md:px-10 w-1/2 h-screen  flex flex-col mt-20 "
//       >
...
//         <div
//           ref={dev_1Ref}
//           className="flex flex-col items-center justify-center gap-7 w-full h-[50%] md:h-[20%]"
//         >
//           <div className="flex md:flex-row flex-col gap-4 justify-around w-full items-center">
//             <h1 className="text-3xl text-[#e68b80] ">html </h1>
//             <svg
//               role="img"
//               viewBox="0 0 24 24"
//               xmlns="http://www.w3.org/2000/svg"
...
//         >
//           <div className="flex md:flex-row flex-col gap-4 justify-around w-full items-center">
//             <h1 className="text-3xl text-[#a6a6d2] ">bootstrap </h1>
//             <svg
//               role="img"
//               viewBox="0 0 24 24"
//               xmlns="http://www.w3.org/2000/svg"
...
//         >
//           <div className="flex md:flex-row flex-col gap-4 justify-around w-full items-center">
//             <h1 className="text-3xl text-[#b1c4ab] ">JavaScript </h1>
//             <svg
//               role="img"
//               viewBox="0 0 24 24"
//               xmlns="http://www.w3.org/2000/svg"
...
//           <AnimatedText
//             ref={subtitle_4Ref}
//             text="Bringing interactivity and dynamics to the web."
//             className="text-base md:text-xl md:whitespace-nowrap "
//           />
//         </div>
//         <div
...
//         >
//           <div className="flex md:flex-row flex-col gap-4 justify-around w-full items-center">
//             <h1 className="text-3xl text-[#213e8f] ">Tailwind CSS </h1>
//             <svg
//               role="img"
//               viewBox="0 0 24 24"
//               xmlns="http://www.w3.org/2000/svg"
...
//           <AnimatedText
//             ref={subtitle_5Ref}
//             text="Crafting fast and flexible designs."
//             className="text-base md:text-xl md:whitespace-nowrap "
//           />
//         </div>
//         <div
...
//         >
//           <div className="flex md:flex-row flex-col gap-4 justify-around w-full items-center">
//             <h1 className="text-3xl text-[#213e8f] ">React JS </h1>
//             <svg
//               role="img"
//               viewBox="0 0 24 24"
//               xmlns="http://www.w3.org/2000/svg"
...
//           <AnimatedText
//             ref={subtitle_6Ref}
//             text="Developing dynamic front-end applications"
//             className="text-base md:text-xl md:whitespace-nowrap "
//           />
//         </div>
//       </div>
